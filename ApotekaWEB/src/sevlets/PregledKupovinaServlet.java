...
public class PregledKupovinaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Kupovina> kupovine = KupovinaManager.listaKupovina();
		request.setAttribute("kupovine", kupovine);
		RequestDispatcher rd = getServletContext().getRequestDispatcher("/pregledKupovina.jsp");
