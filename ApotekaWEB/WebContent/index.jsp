...
<link rel="mask-icon" type=""
	...
	color="#111" />
<link rel="canonical"
	href="https://codepen.io/mikel301292/pen/dMYRYZ?limit=all&page=12&q=svg" />
<link
	href="//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap.min.css"
	rel="stylesheet" id="bootstrap-css">
<script
...
<body>
	<div id="menu">
		...
		<div class="menu-inner">
			...
			<ul>
			<li><h4>Korisnik: ${ulogovaniKorisnik.ime } ${ulogovaniKorisnik.prezime }</h4>
			</li>
				<li><form action="/ApotekaWEB/IndexServlet" method="get">
	...
	<c:choose>
		<c:when test="${ulogovaniKorisnik.uloga == 'admin' }">
			<h2>Dobrodosli u online apoteku admine!</h2>

		</c:when>
		<c:otherwise>
			<h2>Dobrodosli u online apoteku korisnice!</h2>
		</c:otherwise>
	</c:choose>
	<script
