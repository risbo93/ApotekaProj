...
<div id="menu">
		...
		<div class="menu-inner">
			...
			<ul>
				...
				<li><form action="/ApotekaWEB/KupovinaServlet" method="get"><button type="submit" id="button" class="btn btn-primary btn-lg login-button">Kupovina</button></form></li>
				<li><form action="/ApotekaWEB/IndexServlet" method="post"><button type="submit" id="button" class="btn btn-primary btn-lg login-button">Pregled</button></form></li>
				<li><form action="/ApotekaWEB/IndexServlet" method="post"><button type="submit" id="button" class="btn btn-primary btn-lg login-button">O nama</button></form></li>
			</ul>
		</div>
